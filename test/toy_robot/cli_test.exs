defmodule ToyRobot.CLITest do
  ...
  test "provide usage instructions if no arguments specified" do
  ...
  test "provide usage instructions if too many arguments specified" do
    output = capture_io fn ->
  ...
  test "handles commands and reports successfully" do
    ...
    expected_output = """
    The robot is at (1, 4) and is facing NORTH
    """
